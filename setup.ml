...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6c84d121401bfb9db66aebe4782e533c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/containers-misc";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build example(s)";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "containers_misc";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                     cs_name = "containers-misc";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      doc_title = "Containers-misc docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/containers-misc/tree/master/src";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\164\233i\031S\002\"'k\156\167\163Ul\249T";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
